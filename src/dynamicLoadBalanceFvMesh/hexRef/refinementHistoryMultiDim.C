...
namespace Foam
{
    defineTypeNameAndDebug(refinementHistoryMultiDim, 0);
}


// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

void Foam::refinementHistoryMultiDim::writeEntry
(
...
void Foam::refinementHistoryMultiDim::writeDebug
(
...
Foam::refinementHistoryMultiDim::splitCell8::splitCell8()
:
    parent_(-1),
...
Foam::refinementHistoryMultiDim::splitCell8::splitCell8(const label parent)
:
    parent_(parent),
    addedCellsPtr_(nullptr)
{}
...
Foam::refinementHistoryMultiDim::splitCell8::splitCell8(Istream& is)
{
    is >> *this;
}


Foam::refinementHistoryMultiDim::splitCell8::splitCell8(const splitCell8& sc)
:
    parent_(sc.parent_),
    addedCellsPtr_
    (
...
void Foam::refinementHistoryMultiDim::splitCell8::operator=(const splitCell8& s)
{
...
bool Foam::refinementHistoryMultiDim::splitCell8::operator==(const splitCell8& s) const
{
...
Foam::Istream& Foam::operator>>(Istream& is, refinementHistoryMultiDim::splitCell8& sc)
{
...
(
    Ostream& os,
    const refinementHistoryMultiDim::splitCell8& sc
)
{
...
void Foam::refinementHistoryMultiDim::checkIndices() const
{
    // Check indices.
...
Foam::label Foam::refinementHistoryMultiDim::allocateSplitCell
(
    const label parent,
    const label i
)
...
void Foam::refinementHistoryMultiDim::freeSplitCell(const label index)
{
...
void Foam::refinementHistoryMultiDim::markSplit
(
    const label index,
    labelList& oldToNew,
...
void Foam::refinementHistoryMultiDim::mark
(
    const label val,
    const label index,
...
Foam::label Foam::refinementHistoryMultiDim::markCommonCells
(
...
void Foam::refinementHistoryMultiDim::add
(
...
) const
{
    ...
    if (refinementHistoryMultiDim::debug)
    {
...
void Foam::refinementHistoryMultiDim::apply
(
...
Foam::refinementHistoryMultiDim::refinementHistoryMultiDim(const IOobject& io)
:
    regIOobject(io),
    active_(false)
{
    ...
    // that some processors do have refinementHistoryMultiDim and some don't so
    // test for active has to be outside of above condition.
    active_ = (returnReduce(visibleCells_.size(), sumOp<label>()) > 0);

    if (debug)
    {
        Pout<< "refinementHistoryMultiDim::refinementHistoryMultiDim :"
...
Foam::refinementHistoryMultiDim::refinementHistoryMultiDim
(
    const IOobject& io,
    const List<splitCell8>& splitCells,
    const labelList& visibleCells,
...
(
    const IOobject& io,
    const refinementHistoryMultiDim& rh
)
:
    regIOobject(io),
    active_(rh.active_),
    ...
    visibleCells_(rh.visibleCells())
{
    if (debug)
    {
        Pout<< "refinementHistoryMultiDim::refinementHistoryMultiDim : constructed initial"
            << " history." << endl;
    }
}
...
(
    ...
    const UPtrList<const refinementHistoryMultiDim>& refs
)
:
    regIOobject(io),
    active_(false)
{
    ...
    )
    {
        WarningIn
        (
            "refinementHistoryMultiDim::refinementHistoryMultiDim(const IOobject&"
            ", const labelListList&, const PtrList<refinementHistoryMultiDim>&)"
...
Foam::refinementHistoryMultiDim::refinementHistoryMultiDim(const IOobject& io, Istream& is)
:
    regIOobject(io),
    splitCells_(is),
    freeSplitCells_(0),
...
Foam::autoPtr<Foam::refinementHistoryMultiDim> Foam::refinementHistoryMultiDim::clone
(
    const IOobject& io,
...
) const
{
    ...
    return autoPtr<refinementHistoryMultiDim>
    (
        new refinementHistoryMultiDim
        (
            io,
            newSplitCells,
            newVisibleCells,
...
void Foam::refinementHistoryMultiDim::resize(const label size)
{
    label oldSize = visibleCells_.size();

    if (debug)
    {
        Pout<< "refinementHistoryMultiDim::resize from " << oldSize << " to " << size
            << " cells" << endl;
    }
...
void Foam::refinementHistoryMultiDim::updateMesh(const mapPolyMesh& map)
{
    if (active())
    {
        ...
        if (debug)
        {
            Pout<< "refinementHistoryMultiDim::updateMesh : from "
                << visibleCells_.size()
...
void Foam::refinementHistoryMultiDim::subset
(
...
void Foam::refinementHistoryMultiDim::countProc
(
    const label index,
...
void Foam::refinementHistoryMultiDim::distribute(const mapDistributePolyMesh& map)
{
    if (!active())
    {
        FatalErrorInFunction
    ...
    //Pout<< "refinementHistoryMultiDim::distribute :"
...
void Foam::refinementHistoryMultiDim::compact()
{
    if (debug)
    {
        Pout<< "refinementHistoryMultiDim::compact() Entering with:"
    ...
    if (debug)
    {
        Pout<< "refinementHistoryMultiDim::compact : compacted splitCells from "
    ...
    if (debug)
    {
        Pout<< "refinementHistoryMultiDim::compact() NOW:"
            << " freeSplitCells_:" << freeSplitCells_.size()
            << " splitCells_:" << splitCells_.size()
...
void Foam::refinementHistoryMultiDim::writeDebug() const
{
    writeDebug(visibleCells_, splitCells_);
}


void Foam::refinementHistoryMultiDim::storeSplit
(
    const label celli,
...
void Foam::refinementHistoryMultiDim::combineCells
(
...
bool Foam::refinementHistoryMultiDim::read()
{
...
bool Foam::refinementHistoryMultiDim::readData(Istream& is)
{
    is >> *this;
    return !is.bad();
}
...
bool Foam::refinementHistoryMultiDim::writeData(Ostream& os) const
{
    os << *this;
...
Foam::Istream& Foam::operator>>(Istream& is, refinementHistoryMultiDim& rh)
{
...
Foam::Ostream& Foam::operator<<(Ostream& os, const refinementHistoryMultiDim& rh)
{
    const_cast<refinementHistoryMultiDim&>(rh).compact();
