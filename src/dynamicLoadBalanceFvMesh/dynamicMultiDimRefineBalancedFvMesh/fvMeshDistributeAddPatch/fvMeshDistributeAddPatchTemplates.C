...
void Foam::fvMeshDistributeAddPatch::printFieldInfo(const fvMesh& mesh)
{
...
void Foam::fvMeshDistributeAddPatch::saveBoundaryFields
(
...
template<class T, class Mesh>
void Foam::fvMeshDistributeAddPatch::mapBoundaryFields
(
...
template<class T>
void Foam::fvMeshDistributeAddPatch::saveInternalFields
(
...
template<class T>
void Foam::fvMeshDistributeAddPatch::mapExposedFaces
(
    const mapPolyMesh& map,
...
void Foam::fvMeshDistributeAddPatch::initPatchFields
(
...
template<class GeoField>
void Foam::fvMeshDistributeAddPatch::correctBoundaryConditions()
{
...
// template<class T, class Mesh>
// void Foam::fvMeshDistributeAddPatch::appendNewPatchFields(const label oldInternalPatchi)
// {
//     // CorrectBoundaryConditions patch fields of certain type
//     Pout << "appendNewPatchFields" << endl;
//     Pout << "mesh_.boundary().size() " << mesh_.boundary().size() << endl;
...
//         auto& bf = fld.boundaryFieldRef();
//         Pout << "mesh_.boundaryFieldRef().size() " << bf.size() << endl;
//         bf.append
//         (
//             new calculatedFvPatchField<T>
//             (
//                 mesh_.boundary()[oldInternalPatchi],
//                 fld.internalField() 
//             )
//         );
//         Pout << "mesh_.boundaryFieldRef().size() " << bf.size() << endl;
...
template<class GeoField>
void Foam::fvMeshDistributeAddPatch::sendFields
(
    const label domain,
...
template<class GeoField>
void Foam::fvMeshDistributeAddPatch::receiveFields
(
    const label domain,
    const wordList& fieldNames,
    fvMesh& mesh,
